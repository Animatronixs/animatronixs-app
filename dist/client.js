...
(function(exports) {
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_("section-features js--section-features"), Halogen_HTML_Properties.id_("features") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Get food fast \u2014 not fast food") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("long-copy") ])([ Halogen_HTML_Core.text("Hello, we're Animatronixs, your new premium food delivery service. We know you're always busy. No time for cooking. So let us take care of that, we'really good at it, we promise!") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row js-waypoint-1 animated fadeIn") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-4 box") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-infinite-outline icon-big") ])([  ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Up to 365 days/year") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Never cook again! We really mean that. Our subscription plans include up to 365 days/year coverage. You can also choose to order more flexibly if that's your style.") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-4 box") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-stopwatch-outline icon-big") ])([  ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Ready in 20 minutes") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("You're only twenty minutes away from your delicious and super healthy meals delivered right to your home. We work with the best chefs in each town to ensure that you're 100% happy.") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-4 box") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-nutrition-outline icon-big") ])([  ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("100% organic") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("All our vegetables are fresh, organic and local. Animals are raised without added hormones or antibiotics. Good for your health, the environment, and it also tastes better!") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-4 box") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-cart-outline icon-big") ])([  ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Order anything") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("We don't limit your creativity, which means you can order whatever you feel like. You can also choose from our menu containing over 100 delicious meals. It's up to you!") ]) ]) ]) ]);
      };
      var initialState = {
...
(function(exports) {
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_("section-meals"), Halogen_HTML_Properties.id_("meals") ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("meals-showcase clearfix") ])([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.figure([ Halogen_HTML_Properties.class_("meal-photo") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("meal-001.jpg"), Halogen_HTML_Properties.alt("Korean bibimbap with egg and vegetables") ]) ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.figure([ Halogen_HTML_Properties.class_("meal-photo") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("meal-002.jpg"), Halogen_HTML_Properties.alt("Simple italian pizza with cherry tomatoes") ]) ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.figure([ Halogen_HTML_Properties.class_("meal-photo") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("meal-003.jpg"), Halogen_HTML_Properties.alt("Chicken breast steak with vegetables") ]) ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.figure([ Halogen_HTML_Properties.class_("meal-photo") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("meal-004.jpg"), Halogen_HTML_Properties.alt("Autumn pumpkin soup") ]) ]) ]) ]), Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("meals-showcase clearfix") ])([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.figure([ Halogen_HTML_Properties.class_("meal-photo") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("meal-005.jpg"), Halogen_HTML_Properties.alt("Paleo beef steak with vegetables") ]) ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.figure([ Halogen_HTML_Properties.class_("meal-photo") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("meal-006.jpg"), Halogen_HTML_Properties.alt("Healthy baguette with egg and vegetables") ]) ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.figure([ Halogen_HTML_Properties.class_("meal-photo") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("meal-007.jpg"), Halogen_HTML_Properties.alt("Burger with cheddar and bacon") ]) ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.figure([ Halogen_HTML_Properties.class_("meal-photo") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("meal-008.jpg"), Halogen_HTML_Properties.alt("Granola with cherries and strawberries") ]) ]) ]) ]) ]);
      };
      var initialState = {
          b: Data_Maybe.Nothing.value,
          c: Data_Maybe.Nothing.value
...
(function(exports) {
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_("section-steps"), Halogen_HTML_Properties.id_("works") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("How it works \u2014 Simple as 1, 2, 3") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-2 steps-box") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("app-iPhone.png"), Halogen_HTML_Properties.alt("Animatronixs app on iPhone"), Halogen_HTML_Properties.class_("app-screen js--wp-2 animated fadeInUp") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-2 stepsbox") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("works-step clearfix") ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("1") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Choose the subscription plan that best fits your needs and sign up today.") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("works-step clearfix") ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("2") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Order your delicious meal using our mobile app or website. Or you can even call us!") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("works-step clearfix") ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("3") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Enjoy your meal after less than 20 minutes. See you the next time!") ]) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_("btn-app") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("download-app.svg"), Halogen_HTML_Properties.alt("App Store Button") ]) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_("btn-app") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("download-app-android.png"), Halogen_HTML_Properties.alt("Play Store Button") ]) ]) ]) ]) ]);
      };
      var initialState = {
          b: Data_Maybe.Nothing.value,
          c: Data_Maybe.Nothing.value
...
(function(exports) {
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_("section-cities"), Halogen_HTML_Properties.id_("cities") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("We're currently in these cities") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row js--waypoint-3 animated fadeIn") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-4 box") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("lisbon.jpg"), Halogen_HTML_Properties.alt("Lisbon") ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Lisbon") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("city-feature") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-person icon-small") ])([  ]), Halogen_HTML_Core.text("1600+ happy eaters") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("city-feature") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-star icon-small") ])([  ]), Halogen_HTML_Core.text("60+ top chefs") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("city-feature") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-social-twitter icon-small") ])([  ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Core.text("@animatronixs_lx") ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-4 box") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("san-francisco.jpg"), Halogen_HTML_Properties.alt("San Francisco") ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("San Francisco") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("city-feature") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-person icon-small") ])([  ]), Halogen_HTML_Core.text("3700+ happy eaters") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("city-feature") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-star icon-small") ])([  ]), Halogen_HTML_Core.text("160+ top chefs") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("city-feature") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-social-twitter icon-small") ])([  ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Core.text("@animatronixs_sf") ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-4 box") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("berlin.jpg"), Halogen_HTML_Properties.alt("Berlin") ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Berlin") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("city-feature") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-person icon-small") ])([  ]), Halogen_HTML_Core.text("2300+ happy eaters") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("city-feature") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-star icon-small") ])([  ]), Halogen_HTML_Core.text("110+ top chefs") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("city-feature") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-social-twitter icon-small") ])([  ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Core.text("@animatronixs_berlin") ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-4 box") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("london.jpg"), Halogen_HTML_Properties.alt("London") ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("London") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("city-feature") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-person icon-small") ])([  ]), Halogen_HTML_Core.text("1200+ happy eaters") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("city-feature") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-star icon-small") ])([  ]), Halogen_HTML_Core.text("50+ top chefs") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("city-feature") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-social-twitter icon-small") ])([  ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Core.text("@animatronixs_london") ]) ]) ]) ]) ]);
      };
      var initialState = {
          b: Data_Maybe.Nothing.value,
          c: Data_Maybe.Nothing.value
...
(function(exports) {
  ...
  exports["ui"] = ui;
})(PS["SubContainerE.Component"] = PS["SubContainerE.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var CSS = PS["CSS"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];
  var SubContainerF_Component_State = PS["SubContainerF.Component.State"];
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_("section-plans js--section-plans"), Halogen_HTML_Properties.id_("plans") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Start eating healthy today") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-3") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("plan-box js--waypoint-4") ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Premium") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("plan-price") ])([ Halogen_HTML_Core.text("$399"), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("/ month") ]) ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("plan-price-meal") ])([ Halogen_HTML_Core.text("That's only 13.30$ per meal") ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-checkmark-empty icon-small") ])([  ]), Halogen_HTML_Core.text("1 meal every day") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-checkmark-empty icon-small") ])([  ]), Halogen_HTML_Core.text("Order 24/7") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-checkmark-empty icon-small") ])([  ]), Halogen_HTML_Core.text("Access to newest creations") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-checkmark-empty icon-small") ])([  ]), Halogen_HTML_Core.text("Free delivery") ]) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_("btn btn-full") ])([ Halogen_HTML_Core.text("Sign up now") ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-3") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("plan-box js--waypoint-4") ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Pro") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("plan-price") ])([ Halogen_HTML_Core.text("$149"), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("/ month") ]) ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("plan-price-meal") ])([ Halogen_HTML_Core.text("That's only 14.90$ per meal") ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-checkmark-empty icon-small") ])([  ]), Halogen_HTML_Core.text("1 meal 10 days/month") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-checkmark-empty icon-small") ])([  ]), Halogen_HTML_Core.text("Order 24/7") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-checkmark-empty icon-small") ])([  ]), Halogen_HTML_Core.text("Access to newest creations") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-checkmark-empty icon-small") ])([  ]), Halogen_HTML_Core.text("Free delivery") ]) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_("btn btn-ghost") ])([ Halogen_HTML_Core.text("Sign up now") ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-3") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("plan-box js--waypoint-4") ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Starter") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("plan-price") ])([ Halogen_HTML_Core.text("$19"), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("/ meal") ]) ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("plan-price-meal") ])([ Halogen_HTML_Core.text(".") ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-checkmark-empty icon-small") ])([  ]), Halogen_HTML_Core.text("1 meal") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-checkmark-empty icon-small") ])([  ]), Halogen_HTML_Core.text("Order from 8 am to 12 pm") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-close-empty icon-small") ])([  ]), Halogen_HTML_Core.text("") ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("ion-ios-checkmark-empty icon-small") ])([  ]), Halogen_HTML_Core.text("Free delivery") ]) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_("btn btn-ghost") ])([ Halogen_HTML_Core.text("Sign up now") ]) ]) ]) ]) ]) ]);
      };
      var initialState = {
          b: Data_Maybe.Nothing.value,
          c: Data_Maybe.Nothing.value
  ...
  exports["ui"] = ui;
})(PS["SubContainerF.Component"] = PS["SubContainerF.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var CSS = PS["CSS"];
  ...
  exports["ui"] = ui;
})(PS["SubContainerG.Component"] = PS["SubContainerG.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var CSS = PS["CSS"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.form([ Halogen_HTML_Properties.method(DOM_HTML_Indexed_FormMethod.POST.value), Halogen_HTML_Properties.action("#"), Halogen_HTML_Properties.class_("contact-form") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-3") ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("User name") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-2-of-3") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.name("username"), Halogen_HTML_Properties.id_("username"), Halogen_HTML_Properties.placeholder("User name"), Halogen_HTML_Properties.value(state.username), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetUserName.create)) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-3") ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text(" ") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-2-of-3") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputSubmit.value), Halogen_HTML_Properties.disabled(state.loading), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(MakeRequest.create)), Halogen_HTML_Properties.value("Fetch info") ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text((function () {
              ...
              throw new Error("Failed pattern match at ComponentE.Component line 88, column 19 - line 97, column 24: " + [ state.result.constructor.name ]);
          })()) ]) ]);
      };
      var initialState = {
          loading: false,
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at ComponentE.Component line 103, column 10 - line 119, column 12: " + [ v.constructor.name ]);
      };
  ...
  exports["component"] = component;
})(PS["ComponentE.Component"] = PS["ComponentE.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var CSS = PS["CSS"];
  ...
  var SetLEDNumber = (function () {
      function SetLEDNumber(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetLEDNumber.create = function (value0) {
          return function (value1) {
              return new SetLEDNumber(value0, value1);
          };
      };
      return SetLEDNumber;
  })();
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.form([ Halogen_HTML_Properties.method(DOM_HTML_Indexed_FormMethod.POST.value), Halogen_HTML_Properties.action("#"), Halogen_HTML_Properties.class_("contact-form") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-3") ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("LED number") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-2-of-3") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.name("lednumber"), Halogen_HTML_Properties.id_("lednumber"), Halogen_HTML_Properties.placeholder("LED number (choose 1 or 2)"), Halogen_HTML_Properties.value(state.lednumber), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetLEDNumber.create)) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-1-of-3") ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text(" ") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col span-2-of-3") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputSubmit.value), Halogen_HTML_Properties.disabled(state.loading), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(MakeRequest.create)), Halogen_HTML_Properties.value("Toggle LED") ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text((function () {
              if (state.loading) {
                  return "Working...";
              };
              return "";
  ...
  exports["ToggleState"] = ToggleState;
  exports["SetLEDNumber"] = SetLEDNumber;
  exports["MakeRequest"] = MakeRequest;
  exports["component"] = component;
...
(function(exports) {
  ...
  var SubContainerE_Component = PS["SubContainerE.Component"];
  var SubContainerF_Component = PS["SubContainerF.Component"];
  var SubContainerG_Component = PS["SubContainerG.Component"];
  var SubContainerH_Component = PS["SubContainerH.Component"];        
  var Slot = (function () {
      function Slot() {
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(SubContainerA_Component.ui)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(SubContainerB_Component.ui)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(SubContainerC_Component.ui)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp4)(Data_Unit.unit)(SubContainerD_Component.ui)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp5)(Data_Unit.unit)(SubContainerE_Component.ui)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp6)(Data_Unit.unit)(SubContainerF_Component.ui)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp7)(Data_Unit.unit)(SubContainerG_Component.ui)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp8)(Data_Unit.unit)(SubContainerH_Component.ui)(Data_Unit.unit)(Data_Void.absurd) ]);
      };
      var initialState = {};
      var $$eval = function (v) {
      ...
      return Halogen_Component.parentComponent(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Ord.ordVoid)))))))))({
          initialState: Data_Function["const"](initialState),
          render: render,
          "eval": $$eval,
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
...
(function(exports) {
  ...
  var ui = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Router line 219, column 5 - line 219, column 101: " + [ v.constructor.name ]);
      };
