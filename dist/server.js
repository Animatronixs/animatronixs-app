...
(function(exports) {
  ...
  var Led = (function () {
      ...
      Led.create = function (value0) {
          return new Led(value0);
      };
      return Led;
  })();
  var getLedsEndpoint = new Data_Endpoint.Endpoint({
      url: "/getleds",
      method: Data_HTTP_Method.GET.value
  });
  var genericLed = new Data_Generic.Generic(function (v) {
      if (v instanceof Data_Generic.SProd && (v.value0 === "Led.Model.Led" && v.value1.length === 1)) {
          return Control_Apply.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(Led.create))((function (r) {
              if (r instanceof Data_Generic.SRecord && r.value0.length === 2) {
                  return Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(function (color1) {
                      return function (ledId1) {
                          return {
                              color: color1,
                              ledId: ledId1
                          };
      ...
      return new Data_Generic.SigProd("Led.Model.Led", [ {
          sigConstructor: "Led.Model.Led",
      ...
      return new Data_Generic.SProd("Led.Model.Led", [ function ($dollarq) {
          return new Data_Generic.SRecord([ {
              recLabel: "color",
              recValue: function ($dollarq1) {
                  return Data_Generic.toSpine(Data_Generic.genericString)(v.value0.color);
              }
          }, {
              recLabel: "ledId",
              recValue: function ($dollarq1) {
                  return Data_Generic.toSpine(Data_Generic.genericInt)(v.value0.ledId);
              }
          } ]);
      } ]);
  });                                                              
  var encodeJsonLed = new Data_Argonaut_Encode_Class.EncodeJson(Data_Argonaut_Encode_Generic.gEncodeJson(genericLed));
  exports["Led"] = Led;
  exports["getLedsEndpoint"] = getLedsEndpoint;
  exports["genericLed"] = genericLed;
  exports["encodeJsonLed"] = encodeJsonLed;
})(PS["Led.Model"] = PS["Led.Model"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var filterLeds = function (id) {
      return Data_Array.filter(function (v) {
          return v.value0.ledId === id;
      })(myLeds);
  };
  var main = function __do() {
      ...
      Node_Express_Endpoint.hostEndpoint(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.decodeJsonNull)(Data_Argonaut_Encode_Class.encodeJsonArray(Led_Model.encodeJsonLed))(v)(Led_Model.getLedsEndpoint)(function (ledId) {
          return function (v1) {
              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(filterLeds(ledId));
          };
      })();
  ...
  exports["myLeds"] = myLeds;
  exports["myOrders"] = myOrders;
  exports["main"] = main;
  exports["filterLeds"] = filterLeds;
